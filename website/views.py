...
def load_report(report_id):
    ...
    active_table_columns = report['active_table_columns']
    active_table_names = report['active_table_names']
    active_search_columns = report['active_search_columns']
    active_sorting_columns = report['active_sorting_columns']
    active_datetime_columns = report['active_datetime_columns']
    report_start_date = report['report_start_date']
    report_end_date = report['report_end_date']
    table_relations = report['table_relations'] 
